...
const LoginModal = () => {
    ...
    return (
        <>
            ...
            <button
                className="h-10 rounded-full mt-3 w-[19rem] border border-slate-300 hover:bg-sky-100 text-base font-bold text-sky-500"
                type="button"
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-xl">
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                <div className="grid grid-cols-2 m-2 w-[67%]">
                                    ...
                                    <div className="w-screen px-32 mt-6 mb-6">
                                        <div className="text-3xl font-bold">Sign in into X</div>
                                    </div>
                                </div>
